...
// BMI270の設定ファイル(8192バイト)
//
// BMI270は起動時にこの設定をチップへ書き込まないと、加速度・角速度を
// 出力しない。Bosch Sensortec が配布する公式の内容で、意味のある単位に
// 分解できないバイナリのため、そのまま持つ以外にない。
//
// Why not 自分で生成する: チップのファームウェアそのものであり、
//   仕様が公開されていない。バイト列を変えると動作しない。
//
// 出典: StampFly Ecosystem (MIT License, Copyright (c) 2025 Kouhei Ito)
//       firmware/vehicle/components/sf_hal_bmi270/src/bmi270_config_file.c
//       https://github.com/M5Fly-kanazawa/stampfly_ecosystem
//       （元データは Bosch Sensortec の公式設定ファイル）
